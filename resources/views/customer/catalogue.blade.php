            ...
            <aside class="w-full md:w-1/4 rounded-lg font-poppins">
                ...
                <div class="mt-4">
                    <input type="text" placeholder="Search"
                        class="w-full p-2 border rounded-lg focus:ring focus:ring-primary"
                        x-model="searchQuery">
                </div>
                ...
                <div class="mt-2 flex flex-col gap-2 md:gap-8">
                    <template x-for="category in categories">
                        <button class="flex items-center gap-2 px-2 py-2 md:py-3 rounded-lg md:rounded-2xl text-primary"
                            x-bind:class="activeCategory === category.name ? 'border border-primary font-bold text-lg' : 'text-primary-gray'"
