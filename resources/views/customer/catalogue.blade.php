                ...
                <div class="mt-4">
                        <div class="relative w-full">
                            ...
                            <input
                                type="text"
                                placeholder="Search"
                                class="w-full pl-10 p-2 border rounded-lg focus:ring focus:ring-primary"
                                x-model="searchQuery"
                                x-effect="currentPage = 1"
                            >
                        </div>
                        
                </div>
                <h3 class="mt-6 text-sm md:text-lg font-semibold text-primary-gray">Jenis <i class="fa-solid fa-list ml-2"></i></h3>
                            ...
                            <div
                                ...
                                <div class="flex justify-between items-center mt-4">
                                    ...
                                    <x-button.custom class="p-0.5 text-sm md:text-sm"
                                        x-bind:href="'/catalogue-detail/' + product.id"><i class="fa-solid fa-cart-shopping"></i></x-button.custom>
                                </div>
                            </div>
                        </template>
                    </template>
