        ...
        <div class="content my-3">
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <button type="button" class="btn btn-info" onclick="geocodeOfficeAddress()"><i
                                            class="fa fa-search mr-1" aria-hidden="true"></i> Cari</button>
                                    <button type="button" class="btn btn-secondary" onclick="resetToOriginal()"><i
                                            class="fa fa-undo mr-1" aria-hidden="true"></i> Reset</button>
                                </div>
                ...
                <div class="col-lg-6">
                    ...
                    @foreach (json_decode($system['our_coverage'], true) as $key => $coverage)
                        <div class="card">
                            <div class="card-header"><strong class="card-title">Area yang di tangani
                                    {{ $key + 1 }}</strong></div>
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <button type="button" class="btn btn-info"><i
                                                class="fa fa-search mr-1" aria-hidden="true"></i> Cari</button>
                                        <button type="button" class="btn btn-secondary"><i class="fa fa-undo mr-1"
                                                aria-hidden="true"></i> Reset</button>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Radius</label>
                                    <input class="form-control" name="radius" type="number" value="{{ $coverage['radius'] }}" required>
                                </div>
                            </div>
                        </div>
                    @endforeach
            ...
            <button type="submit" class="btn btn-primary mt-3"><i class="fa fa-floppy-o mr-2"
                    aria-hidden="true"></i>
                Simpan</button>
        </div>
    </form>
